class Turtle {
  ...
  //   let params = [];
  //   params.push(1); // colorMode (start with colorMode set to add fill)
  ...
  //   }
  //   pop();
  //   // We need to reset sentence to level is not doubled
  //   this.setRule(lsystemData);
  //   params[0] = 0; // Set colorMode to 0 to add stroke
  //   push();
  //   translate(width * wadj, height * hadj);
  //   rotate(fractalAngle);
  //   if (level > this.maxLevel) {
