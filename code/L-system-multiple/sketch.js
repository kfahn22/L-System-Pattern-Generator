...
let lsystem2;
let ruleChoice2 = "ADH231a";
let shapeChoice2 = "Flower";
let sliderValues2 = [
  1300,
  0.05, // wadj
  0.5, // hadj
...
let lsystems = [];
let fractalAngle = 0;
let n = 10; // number of lsysttems to render
...
for (let i = 0; i < n; i++)
 { 
  let sliderValues = [
    ...
    220, // stroke alpha
    150, // fill alpha
    0 + random(30) * i, // fractal angle
    random(0.01, 0.03), // length
    random(0.38, 0.42), // shapeScale
    3.8, // a
    1, // b
    8, // m
    1, // n1
  ...
  lsystems.push(addLsystem(10, sliderValues, "ADH231a", "Flower"));}
