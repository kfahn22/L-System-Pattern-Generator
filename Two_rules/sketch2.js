...
function setup() {
  ...
  // [ruleDropdown0, shapeDropdown0, fillDropdown0, strokeDropdown0] = addLsystemDropdowns(x, "dragon2", "gear", "blue", "purple");
  ...
  if (addSecondFractal.checked() === true) {
    ...
    // shapeDropdown1 = addShapesDropdown(x + 450, 40, "gear");
    // fillDropdown1 = addPalettes(x + 450, 75, "orange");
    // strokeDropdown1 = addPalettes(x + 450, 115, "orange");
...
function addLsystemDropdowns(x, lsystem, shape, fillColor, strokeColor) {
  ...
  shapeDropdown = addShapesDropdown(x, 40, shape);
  fillDropdown = addPalettes(x, 75, fillColor);
  strokeDropdown = addPalettes(x, 115, strokeColor);
...
function addSecondLsystem() {
  ...
  lsystem1 =
    addLsystemDropdowns(x + 450, "dragon2", "gear", "orange", "orange");
    secondAdded = true;
}
...
function adjustFill(fillPalette, strokePalette, addStroke, sw, a, fillShape) {
