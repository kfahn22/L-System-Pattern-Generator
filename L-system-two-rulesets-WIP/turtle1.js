class Turtle {
  constructor(lsystemArrays, images) {
    ...
    for (let i = 0; i < this.lsystemArrays.length; i++) {
      ...
      // this.currentStrokePalette = this.lsystemValues[3];
      // console.log(this.lsystemValues[3])
      // this.currentFillPalette = this.lsystemValues[4];
    }
  ...
  addLsystemStrokeFill(currentStrokePalette, currentFillPalette, values) {
    let wadj = values[0];
    let hadj = values[1];
    let level = values[2];
    let sw = values[3];
  ...
  addLsystem(colorMode, currentStrokePalette, currentFillPalette, values) {
    let wadj = values[0];
    let hadj = values[1];
    let level = values[2];
    let sw = values[3];
