...
function setSystemVariables(lsystems) {
  let lsystemValues = [];
  // let lsystemValues0 = lsystemValues[0]
  // let lsystemValues1 = lsystemValues[1];
  for (let i = 0; i < 1; i++) {
    // lsystemValues = [];
    //controls = lsystems[i][0];
    // values = updateValues(lsystems[i]);
    ...
    if (lsystemValues[1][5] === true && lsystemValues[1][6] === false) {
      // colorMode = 0
      lsystemValues[4] = 0;
    } else if (lsystemValues[1][5] === false && lsystemValues[1][6] === true) {
      // colorMode = 1;
      lsystemValues[4] = 1;
    } else if (lsystemValues[1][5] === true && lsystemValues[1][6] === true) {
      // colorMode = 2;
      lsystemValues[4] = 2;
    }
