...
function preload() {
  ...
  //images[0] = loadImage("images/design1.jpg");
  // images[1] = loadImage("images/design2.jpg");
  for (let i = 0; i < 8; i++) {
    const path = "assets";
    images[i] = loadImage(`${path}/${i}.jpg`);
  }
  // images[0] = loadImage(
  //   "../assets/Ruleset-shape-examples/adha231a-quadrilateral2.jpg"
  // );
  // images[1] = loadImage(
  //   "../assets/Ruleset-shape-examples/square-skierpinski-astroid.jpg"
  // );
}
